...
var AccountModal = function (_a) {
    var _b;
    var account = _a.account, profile = _a.profile, logout = _a.logout, _c = _a.onDismiss, onDismiss = _c === void 0 ? function () { return null; } : _c;
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        profile && (React__default['default'].createElement(Flex, { alignItems: "center" },
            ((_b = profile.image) === null || _b === void 0 ? void 0 : _b.startsWith("http")) && (React__default['default'].createElement(StyledAvatar, { style: { marginLeft: "0px", marginRight: "10px" }, title: profile === null || profile === void 0 ? void 0 : profile.username },
                React__default['default'].createElement("a", { target: "_blank", href: "https://app.bch.domains/name/" + (profile === null || profile === void 0 ? void 0 : profile.username), "aria-label": "Link to profile" },
                    React__default['default'].createElement("img", { src: profile === null || profile === void 0 ? void 0 : profile.image, alt: "profile avatar", height: "64px", width: "64px" })))),
...
var useWalletModal = function (login, logout, account, profile) {
    ...
    var onPresentAccountModal = useModal(React__default['default'].createElement(AccountModal, { account: account || "", profile: profile, logout: logout }))[0];
    return { onPresentConnectModal: onPresentConnectModal, onPresentAccountModal: onPresentAccountModal };
};

var UserBlock = function (_a) {
    var account = _a.account, profile = _a.profile, login = _a.login, logout = _a.logout;
...
var UserBlock$1 = React__default['default'].memo(UserBlock, function (prevProps, nextProps) { return prevProps.account === nextProps.account && prevProps.profile === nextProps.profile; });
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu },
            ...
            React__default['default'].createElement(Flex, null,
                React__default['default'].createElement(UserBlock$1, { account: account, profile: profile, login: login, logout: logout }),
