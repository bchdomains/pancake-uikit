...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        profile && (React.createElement(Flex, { alignItems: "center" },
            ((_b = profile.image) === null || _b === void 0 ? void 0 : _b.startsWith("http")) && (React.createElement(StyledAvatar, { style: { marginLeft: "0px", marginRight: "10px" }, title: profile === null || profile === void 0 ? void 0 : profile.username },
                React.createElement("a", { target: "_blank", href: "https://app.bch.domains/name/" + (profile === null || profile === void 0 ? void 0 : profile.username), "aria-label": "Link to profile" },
                    React.createElement("img", { src: profile === null || profile === void 0 ? void 0 : profile.image, alt: "profile avatar", height: "64px", width: "64px" })))),
...
var useWalletModal = function (login, logout, account, profile) {
    ...
    var onPresentAccountModal = useModal(React.createElement(AccountModal, { account: account || "", profile: profile, logout: logout }))[0];
...
var UserBlock$1 = React.memo(UserBlock, function (prevProps, nextProps) { return prevProps.account === nextProps.account && prevProps.profile === nextProps.profile; });
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            ...
            React.createElement(Flex, null,
                React.createElement(UserBlock$1, { account: account, profile: profile, login: login, logout: logout }),
